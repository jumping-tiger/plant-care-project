      ...
      <View style={[styles.screen, { paddingTop: insets.top + 16 }]}>
        ...
        <View style={styles.chooseSection}>
          ...
          <TouchableOpacity onPress={() => setMode('manual')} activeOpacity={0.7} style={styles.chooseCard}>
            <MaterialCommunityIcons name="pencil" size={36} color="#4caf50" />
          ...
          <TouchableOpacity onPress={handlePhotoAdd} activeOpacity={0.7} style={styles.chooseCard}>
            {identifying ? (
              ...
              <MaterialCommunityIcons name="camera" size={36} color="#4caf50" />
            )}
...
const styles = StyleSheet.create({
  ...
  chooseHint: { color: '#888', fontSize: 14, textAlign: 'center', marginBottom: 8 },
  chooseCard: {
    backgroundColor: '#1e3e1e', borderRadius: 16, padding: 28,
    alignItems: 'center', gap: 10,
  },
  chooseTitle: { color: '#e0e0e0', fontSize: 17, fontWeight: '600' },
  chooseDesc: { color: '#888', fontSize: 13, textAlign: 'center', lineHeight: 19 },
  ...
  aiSpeciesCard: {
    backgroundColor: '#1e3a1e', borderRadius: 8, padding: 10, marginBottom: 8,
    flexDirection: 'row', alignItems: 'center', gap: 8,
  },
  aiSpeciesText: { color: '#4caf50', fontSize: 14 },
  speciesBtn: {
    backgroundColor: '#1e2e1e', borderRadius: 10, padding: 12, marginBottom: 6,
  ...
  personalityBtn: {
    backgroundColor: '#1e2e1e', borderRadius: 10, padding: 14, marginBottom: 8,
    flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: 'transparent',
  },
  personalityBtnActive: { borderColor: '#4caf50', backgroundColor: '#1e3e1e' },
  personalityEmoji: { fontSize: 28 },
  personalityLabel: { color: '#aaa', fontSize: 15, fontWeight: '600', marginBottom: 2 },
  personalityLabelActive: { color: '#4caf50' },
  personalityDesc: { color: '#666', fontSize: 12 },
