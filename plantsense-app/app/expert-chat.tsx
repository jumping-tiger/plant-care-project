      ...
      <View style={styles.screen}>
        ...
        {loading && (
          <View style={styles.typingRow}>
            ...
            <ActivityIndicator size="small" color="#4caf50" style={{ marginLeft: 8 }} />
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  botAvatar: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: '#1e3e1e',
    alignItems: 'center', justifyContent: 'center', marginRight: 8,
  },
  bubble: { maxWidth: '75%', borderRadius: 14, padding: 12 },
  bubbleBot: { backgroundColor: '#1e3e1e', borderBottomLeftRadius: 4 },
  bubbleUser: { backgroundColor: '#2d5a27', borderBottomRightRadius: 4 },
  bubbleText: { color: '#e0e0e0', fontSize: 14, lineHeight: 21 },
  ...
  inputBar: {
    ...
    backgroundColor: '#1a2e1a', borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.08)',
  },
  input: {
    flex: 1, backgroundColor: '#0f1f0f', borderRadius: 20, paddingHorizontal: 16,
    paddingVertical: 10, color: '#e0e0e0', fontSize: 14, maxHeight: 100,
    borderWidth: 1, borderColor: '#2a3e2a', marginRight: 8,
  },
  sendBtn: { backgroundColor: '#2d5a27', width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
