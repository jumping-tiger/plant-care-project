  ...
  if (!plant) {
    return (
      <View style={[styles.screen, { justifyContent: 'center', alignItems: 'center' }]}>
        <Text style={{ color: '#888' }}>植物信息不存在</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  content: { padding: 16 },
  heroCard: { backgroundColor: '#1e3e1e', borderRadius: 14, padding: 20, flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
  heroEmoji: { fontSize: 56, marginRight: 16 },
  plantName: { color: '#e0e0e0', fontSize: 24, fontWeight: 'bold' },
  plantFamily: { color: '#4caf50', fontSize: 13, marginTop: 4 },
  card: { backgroundColor: '#1e2e1e', borderRadius: 12, padding: 16, marginBottom: 10 },
  cardTitle: { color: '#4caf50', fontSize: 14, fontWeight: '600', marginBottom: 10 },
  cardContent: { color: '#ccc', fontSize: 14, lineHeight: 22 },
  infoCard: { backgroundColor: '#1e2e1e', borderRadius: 12, padding: 14, marginBottom: 8, flexDirection: 'row', alignItems: 'flex-start' },
  infoLabel: { color: '#4caf50', fontSize: 12, fontWeight: '600', marginBottom: 4 },
  infoValue: { color: '#ccc', fontSize: 13, lineHeight: 20 },
  tipRow: { flexDirection: 'row', marginBottom: 8, gap: 8 },
  tipBullet: { color: '#4caf50', fontSize: 16, lineHeight: 22 },
  tipText: { color: '#ccc', fontSize: 13, lineHeight: 22, flex: 1 },
});
