    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        <View style={styles.logoRow}>
          <MaterialCommunityIcons name="leaf" size={48} color="#4caf50" />
...
const styles = StyleSheet.create({
  ...
  appName: { color: '#4caf50', fontSize: 40, fontWeight: 'bold' },
  subtitle: { color: '#666', fontSize: 13, marginBottom: 48, textAlign: 'center' },
  form: { width: '100%' },
  ...
  loginBtn: {
    backgroundColor: '#2d5a27', borderRadius: 12, padding: 16,
    alignItems: 'center', marginTop: 28,
  },
  loginBtnDisabled: { opacity: 0.5 },
  loginBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  registerLink: { alignItems: 'center', marginTop: 20 },
  registerLinkText: { color: '#4caf50', fontSize: 14 },
});
